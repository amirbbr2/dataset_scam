...
$(window).bind("load", function() {
    var timeout = setTimeout(function() { $("img.lazyright").trigger("sporty") }, 1);
});     
        ...
        setUpListeners: function() {
            ...
            $('.btn-color-toggle').on('click', function() {
                if($('body').hasClass('light')) {
                    ...
                    $(this).find('img').attr('src', adres+'theme/images/icon_bulb_dark.png');
                } else { if($('body').hasClass('dark'))
                    $('body').removeClass('dark').addClass('light');
                    $(this).find('img').attr('src', adres+'theme/images/icon_bulb_light.png');
                }
            });
