if (top.location != location) {
		...
		$(document).on("click", "#show_table", function() {
			 ...
			 var name = ['#email','#database','#domain','#ftp','#php','#panel','#place','#gzip'];
...
$(".modal").on('shown.bs.modal', function(event){
    ...
    $(window).scroll(function() {
        ...
        var topOfWindow = $(window).scrollTop();
            ...
            setTimeout(function(){
				$('#reg01-p02').find('.reg03-p04 img').addClass("reg03-p02-block ");}, 150);
            setTimeout(function(){
				$('#reg01-p02').find('.reg03-p05 img').addClass("reg03-p02-block ");}, 300);
            setTimeout(function(){
				$('#reg01-p02').find('.reg03-p06 img').addClass("reg03-p02-block ");}, 450);
            setTimeout(function(){
				$('#reg01-p02').find('.reg03-p07 img').addClass("reg03-p02-block ");}, 600);
            setTimeout(function(){
				$('#reg01-p02').find('.reg03-p08 img').addClass("reg03-p02-block ");}, 750);
            setTimeout(function(){
				$('#reg01-p02').find('.reg03-p09 img').addClass("reg03-p02-block ");}, 900);
            setTimeout(function(){
				$('#reg01-p02').find('.reg03-p10 img').addClass("reg03-p02-block ");}, 1050);
            setTimeout(function(){
				$('#reg01-p02').find('.reg03-p11 img').addClass("reg03-p02-block ");}, 1200);
            setTimeout(function(){
				$('#reg01-p02').find('.reg03-p12 img').addClass("reg03-p02-block ");}, 1350);
            setTimeout(function(){
				$('#reg01-p02').find('.reg03-p13 img').addClass("reg03-p02-block ");}, 1500);
            setTimeout(function(){
				$('#reg01-p02').find('.reg03-p14 img').addClass("reg03-p02-block ");}, 1650);
            setTimeout(function(){
				$('#reg01-p02').find('.reg03-p15 img').addClass("reg03-p02-block ");}, 1800);
            setTimeout(function(){
				$('#reg01-p02').find('.reg03-p16 img').addClass("reg01-p02-block ");}, 2000);
            setTimeout(function(){
				$('#reg01-p02').find('.reg03-p17 img').addClass("reg01-p02-block ");}, 2300);
            }
        });
    });
...
function travers(){
	...
	jQuery(document).ready(function() {
		...
		if(url !=="/cart.php"){
			jQuery("body *").not( "#twofaactivation *" ).not('#server_status_time').not('#not_persian').not( "style" ).each(function(k, v) {
