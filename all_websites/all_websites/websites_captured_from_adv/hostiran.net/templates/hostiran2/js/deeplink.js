...
iOS: {
  appId: "1061379586",
  appName: "hostiran",
  storeUrl: "https://new.sibapp.com/applications/%D9%85%D8%AC%D9%84%D9%87-%D8%A7%DB%8C%D9%86%D8%AA%D8%B1%D9%86%D8%AA%DB%8C-%D9%87%D8%A7%D8%B3%D8%AA-%D8%A7%DB%8C%D8%B1%D8%A7%D9%86"
},
android: {
  appId: "com.hostiran.blogapp",
  storeUrl: "https://play.google.com/store/apps/details?id=hostiranmag.hostiran.com.hostiranmag"
}
});



$('.deep-app-link .deep-link').on('click', function(e) {
	e.preventDefault();
	deeplink.open($(this).attr('data-uri'));
	return false;
});

$('.deep-app-link .deep-link-close').on('click', function(e) {
	e.preventDefault();
	$(this).parents('.deep-app-link').slideUp();
	$(this).parents('body').find('.navbar-inverse').addClass('removed-margin-top');
});