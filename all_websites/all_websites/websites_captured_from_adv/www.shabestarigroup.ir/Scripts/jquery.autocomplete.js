...
(function ($) {
    ...
    Autocomplete.prototype={
        ...
        initialize: function () {
            ...
            $('<div id="'+this.mainContainerId+'" style="position:absolute;z-index:9999;"><div class="autocomplete-w1"><div class="autocomplete" id="'+autocompleteElId+'"></div></div></div>').appendTo('body');
            ...
            $(window).resize(function () { me.fixPosition(); });
        },
        ...
        fixPosition: function () {
            ...
            if(this.options.direction=="ltr")
                ...
                $('#'+this.mainContainerId).css({ top: (offset.top+this.el.innerHeight())+'px',right: ($(window).width()-(offset.left+this.el.outerWidth()))+'px' });
        },
                ...
                if(!me.options.useWebMethod)
                    ...
                    $.ajax({
                        ...
                        error: function (jqXhr,textStatus,errorThrown) {
                            alert("در ذخیره خطایی رخ داده است.");
                        }
                    });
                }
            }
