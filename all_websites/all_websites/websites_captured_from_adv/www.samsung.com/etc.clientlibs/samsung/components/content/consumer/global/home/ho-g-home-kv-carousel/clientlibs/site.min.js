...
a&&a.pause()}};b.prototype.playCarousel=function(){if(this.applyCarouselControlEvent)if(this.isCarousel)this.autoplay&&this.indicator.play(this.els.indicatorEl);else{var a=this.els.slideEls[0].querySelector(".home-kv-carousel__background-media-wrap .video video");a&&!a.ended&&a.play()}};b.prototype.findLoadedVideo=function(){var a=this;[].concat($jscomp.arrayFromIterable(this.els.slideEls)).forEach(function(e,b){var c=e.querySelector(".home-kv-carousel__background-media-wrap .video");c&&(c.querySelector("video")?
a.setContentsMotion(c.querySelector("video"),b):c.addEventListener("videoInit",function(){a.setContentsMotion(c.querySelector("video"),b)}))})};b.prototype.setContentsMotion=function(a,b){var c=this;a.addEventListener("timeupdate",function(){if(!c.isCarousel||c.isCarousel&&b===c.swiper.activeIndex)a.currentTime>=c.contentsMotionDelay&&!c.isShowText?(c.els.slideEls[b].querySelector(".home-kv-carousel__text-wrap").classList.add("home-kv-carousel__text-wrap--show"),c.isShowText=!0,c.showTextIndex=b):
a.currentTime<c.contentsMotionDelay&&c.isShowText&&(c.els.slideEls[b].querySelector(".home-kv-carousel__text-wrap").classList.remove("home-kv-carousel__text-wrap--show"),c.isShowText=!1,c.showTextIndex=-1)})};b.prototype.bindEvents=function(){var a=this;[].concat($jscomp.arrayFromIterable(this.els.slideEls)).forEach(function(b){var c=b.querySelector(".home-kv-carousel__slide-inner");c.addEventListener("mouseenter",function(){a.isTouchScreen||a.pauseCarousel()});c.addEventListener("mouseleave",function(){a.isTouchScreen||
a.playCarousel()});[].concat($jscomp.arrayFromIterable(b.querySelectorAll(".cta"))).forEach(function(b){b.addEventListener("focus",function(){a.pauseCarousel()});b.addEventListener("focusout",function(){a.playCarousel()})});var e=c.querySelector(".home-kv-carousel__cta--layer-video");if(e){var d=c.querySelector(".home-kv-carousel__layer-video"),f=d.querySelector(".video"),g=d.querySelector(".home-kv-carousel__btn-video-close");e.addEventListener("click",function(e){a.applyCarouselControlEvent=!1;
a.isLayerVideoPlay=!0;a.els.arrowIndicatorWrapEL.style.display="none";a.els.indicatorWrapEl.style.display="none";d.style.display="block";a.video.init(f);f.setAttribute("tabindex","0");f.focus();b.setAttribute("aria-hidden","true");[].concat($jscomp.arrayFromIterable(c.querySelectorAll(".cta"))).forEach(function(a){a.setAttribute("tabindex","-1");a.setAttribute("aria-hidden","true")});e.preventDefault()});g.addEventListener("click",function(){a.applyCarouselControlEvent=!0;a.isLayerVideoPlay=!1;a.video.dispose(f);
d.removeAttribute("style");a.els.arrowIndicatorWrapEL.removeAttribute("style");a.els.indicatorWrapEl.removeAttribute("style");f.removeAttribute("tabindex");b.removeAttribute("aria-hidden");[].concat($jscomp.arrayFromIterable(c.querySelectorAll(".cta"))).forEach(function(a){a.removeAttribute("tabindex");a.removeAttribute("aria-hidden")});e.focus()})}});this.isCarousel&&(this.els.indicatorEl.addEventListener("indicatorMove",function(b){a.swiper.slideToLoop(b.detail)}),this.els.indicatorControlButtonEl&&
this.els.indicatorControlButtonEl.addEventListener("click",function(){a.autoplay=!a.autoplay}),this.swiper.on("slideChange",function(){a.applyCarouselControlEvent=!1;a.swiper.slideToLoop(a.swiper.realIndex);a.lazyLoad.setLazyLoadManually(a.els.slideEls[a.swiper.activeIndex]);a.setComponentTextColorForIndicator();a.checkSwiperStatus();a.setAccessibility();if(a.isLayerVideoPlay){var b=a.els.slideEls[a.swiper.previousIndex].querySelector(".home-kv-carousel__layer-video"),c=b.querySelector(".video");
a.video.dispose(c);c.removeAttribute("tabindex");b.removeAttribute("style");a.els.arrowIndicatorWrapEL.removeAttribute("style");a.els.indicatorWrapEl.removeAttribute("style");a.applyCarouselControlEvent=!0;a.isLayerVideoPlay=!1}a.isShowText&&(a.els.slideEls[a.showTextIndex].querySelector(".home-kv-carousel__text-wrap").classList.remove("home-kv-carousel__text-wrap--show"),a.isShowText=!1,a.showTextIndex=-1);a.indicator.move(a.els.indicatorEl,a.swiper.realIndex)}),this.swiper.on("slideChangeTransitionEnd",
function(){a.applyCarouselControlEvent=!0;(a.els.slideEls[a.swiper.activeIndex].querySelector(".home-kv-carousel__slide-inner").matches?a.els.slideEls[a.swiper.activeIndex].querySelector(".home-kv-carousel__slide-inner").matches(":hover"):a.els.slideEls[a.swiper.activeIndex].querySelector(".home-kv-carousel__slide-inner").msMatchesSelector(":hover"))&&!a.isTouchScreen&&a.pauseCarousel()}),this.swiper.on("resize",function(){a.checkSwiperStatus()}));[].concat($jscomp.arrayFromIterable(this.els.popupVideoCtaEls)).forEach(function(b,
c){b.addEventListener("click",function(){a.applyCarouselControlEvent=!1;a.popupVideo.open(a.els.popupVideoEl,c,b)})});this.els.popupVideoEl&&this.els.popupVideoEl.addEventListener("popupVideoClose",function(){a.applyCarouselControlEvent=!0});[].concat($jscomp.arrayFromIterable(this.els.preRegistrationCtaEls)).forEach(function(b){b.addEventListener("click",function(){a.applyCarouselControlEvent=!1;document.body.style.overflow="hidden";a.els.preRegistrationEl.classList.add("pre-registration--show");
a.els.preRegistrationIframeEl.focus();a.els.preRegistrationIframeEl.setAttribute("src",b.dataset.preRegistrationSrc);a.focusTargetEl=b})});this.els.preRegistrationCloseButtonEl&&this.els.preRegistrationCloseButtonEl.addEventListener("click",function(){a.els.preRegistrationIframeEl.removeAttribute("src");a.els.preRegistrationEl.classList.remove("pre-registration--show");document.body.removeAttribute("style");a.focusTargetEl instanceof Element&&a.focusTargetEl.focus();a.focusTargetEl={};a.applyCarouselControlEvent=
!0});this.els.preRegistrationLoopingStartEl&&this.els.preRegistrationLoopingStartEl.addEventListener("focus",function(){a.els.preRegistrationCloseButtonEl.focus()});this.els.preRegistrationLoopingEndEl&&this.els.preRegistrationLoopingEndEl.addEventListener("focus",function(){a.els.preRegistrationIframeEl.focus()});this.els.swiperAutoplayStopButtonEl&&this.els.swiperAutoplayStopButtonEl.addEventListener("click",function(){a.pauseCarousel()});document.addEventListener("scroll",function(){a.checkCarouselShow()});
...
a=640*this.els.el.offsetWidth/1440:this.els.el.classList.contains("home-kv-carousel--height-smedium")?a=344*this.els.el.offsetWidth/1440:this.els.el.classList.contains("home-kv-carousel--height-small")&&(a=320*this.els.el.offsetWidth/1440):"mobile"===this.getCurrentDevice()&&(this.els.el.classList.contains("home-kv-carousel--height-large")?a=640*this.els.el.offsetWidth/360:this.els.el.classList.contains("home-kv-carousel--height-medium")?a=540*this.els.el.offsetWidth/360:this.els.el.classList.contains("home-kv-carousel--height-smedium")?
a=400*this.els.el.offsetWidth/360:this.els.el.classList.contains("home-kv-carousel--height-small")&&(a=320*this.els.el.offsetWidth/360));[].concat($jscomp.arrayFromIterable(this.els.slideEls)).forEach(function(b){b.querySelector(".home-kv-carousel__slide-inner").style.height=a+"px"})}else[].concat($jscomp.arrayFromIterable(this.els.slideEls)).forEach(function(a){a.querySelector(".home-kv-carousel__slide-inner").removeAttribute("style")})};b.prototype.playCustomVideo=function(){this.els.arrowIndicatorWrapEL.style.display=
"none";this.els.indicatorWrapEl.style.display="none";this.applyCarouselControlEvent=!1};b.prototype.stopCustomVideo=function(){this.els.arrowIndicatorWrapEL.removeAttribute("style");this.els.indicatorWrapEl.removeAttribute("style");this.applyCarouselControlEvent=!0;this.els.el.querySelector(".home-kv-carousel__slide--teasing .cta").focus()};b.instances=new WeakMap;var f={initAll:function(){[].concat($jscomp.arrayFromIterable(document.querySelectorAll(".home-kv-carousel"))).forEach(function(a){b.instances.has(a)||
new b(a)})},playCustomVideo:function(){b.instances.get(document.querySelector(".home-kv-carousel")).playCustomVideo()},stopCustomVideo:function(){b.instances.get(document.querySelector(".home-kv-carousel")).stopCustomVideo()}};window.sg.components.homeKvCarousel=f;d.ready(function(){return f.initAll()})})();