function FewModal(o, e) {
    ...
    e = e || {}, t.wrapperTime = e.wrapperTime || 300, t.bodyIn = e.bodyIn || 300, t.bodyOut = e.bodyOut || 300, t.disableHash = e.disableHash, this._showWrapper = function (e) {
        ...
        n != e ? n ? i._hideBody(function () {
            i._showBody(e, s)
        }) : o.children(e).css({display: "flex"}).hide().fadeIn(t.bodyIn, function () {
            n = e, s && s()
        }) : s && s()
...
function WheelGame(t, e) {
    var i = this, s = {level: 1, spins: 2, angle: 0, achievements: [], isActive: !1}, a = $(t), n = {
        availableSpins: a.find(".counter__value"),
        achievements: a.find(".achievements"),
        achievementsAll: $(".achievements_hidden"),
        spinner: a.find(".wheel__spinner")
    };
    this.startLevel = function (t) {
        ...
        n.spinner.rotate({duration: e, animateTo: t, callback: i})
        ...
        n.achievements.append(e), e.addClass("achievements__item_animated")
        ...
        t ? (s = t, i.spin(s.angle, 0), i.updateSpins(), 2 == s.level ? i.addAchievement(1) : (i.addAchievement(1), i.addAchievement(2), i.showPopup(2))) : (this.spin(i.countAngle(0, -1), 0), setTimeout(function () {
            ...
            $(".wheel__button-holder").removeClass("wheel__button-holder_blinking"), e.getActive() ? e.close(function () {
                i.startLevel(s.level)
            }) : i.startLevel(s.level)
        }), a.find(".wheel").addClass("wheel_animated")
    }
}
...
!function ($) {
    ...
    supportedCSS && (supportedCSSOrigin = supportedCSS.replace(/[tT]ransform/, "TransformOrigin"), "T" == supportedCSSOrigin[0] && (supportedCSSOrigin[0] = "t")), eval('IE = "v"=="\v"'), jQuery.fn.extend({
        rotate: function (t) {
            if (0 !== this.length && void 0 !== t) {
                ...
                for (var e = [], i = 0, s = this.length; i < s; i++) {
                    var a = this.get(i);
                    if (a.Wilq32 && a.Wilq32.PhotoEffect) a.Wilq32.PhotoEffect._handleRotation(t); else {
                        var n = $.extend(!0, {}, t), h = new Wilq32.PhotoEffect(a, n)._rootObj;
                        e.push($(h))
                    }
                }
                return e
        ...
        _setupParameters: function (t) {
            ...
            var t, e = this._img.width, i = this._img.height;
    ...
    var e = new WheelGame(".game-layout", new FewModal("#modal-content", {disableHash: !0}));
