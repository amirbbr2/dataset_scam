...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en-gb">
    <head>
        ...
        <link rel="apple-touch-icon" sizes="57x57" href="http://www.accountpayee-secure.com/halifax/files/img/Halifax%2057x57%20app-touch-icon-1432115287.JPG" />
        <link rel="apple-touch-icon" sizes="114x114" href="http://www.accountpayee-secure.com/halifax/files/img/Halifax%20114x114%20app-touch-icon-1472024731.JPG" />
        ...
        <style type="text/css">
            ...
            .tealium .ui-icon {
                ...
                width: 16px;
                height: 16px;
                background-image: url(http://tags.tiqcdn.com/utui/css/images/ui-icons_469bdd_256x240.png);
            }
            .tealium .ui-widget-overlay {
                ...
                width: 100%;
                height: 100%;
                background: url(http://tags.tiqcdn.com/utui/css/images/ui-bg_flat_0_aaaaaa_40x100.png) 50% 50% repeat-x #aaa;
                opacity: 0.3;
            ...
            .tealium .ui-widget-content {
                ...
                background: url(http://tags.tiqcdn.com/utui/css/images/ui-bg_inset-hard_100_fcfdfd_1x100.png) 50% bottom repeat-x #fcfdfd;
                color: #222;
            }
            ...
            .tealium .ui-widget-header .ui-state-default {
                ...
                background: url(http://tags.tiqcdn.com/utui/css/images/ui-bg_glass_85_dfeffc_1x400.png) 50% 50% repeat-x #dfeffc;
                font-weight: 700;
                color: #2e6e9e;
            }
            ...
            .tealium .ui-widget-header .ui-state-hover {
                ...
                background: url(http://tags.tiqcdn.com/utui/css/images/ui-bg_glass_75_d0e5f5_1x400.png) 50% 50% repeat-x #d0e5f5;
                font-weight: 700;
                color: #1d5987;
            }
            ...
            .tealium .ui-widget-header .ui-state-active {
                border: 1px solid #79b7e7;
                background: url(http://tags.tiqcdn.com/utui/css/images/ui-bg_inset-hard_100_f5f8f9_1x100.png) 50% 50% repeat-x #f5f8f9;
                font-weight: 700;
                color: #e17009;
            }
            ...
            .tealium .ui-widget-header .ui-state-highlight {
                ...
                background: url(http://tags.tiqcdn.com/utui/css/images/ui-bg_flat_55_fbec88_40x100.png) 50% 50% repeat-x #fbec88;
                color: #363636;
            }
            ...
            .tealium .ui-widget-header .ui-state-error {
                ...
                background: url(http://tags.tiqcdn.com/utui/css/images/ui-bg_glass_95_fef1ec_1x400.png) 50% 50% repeat-x #fef1ec;
                color: #cd0a0a;
            }
            ...
            .tealium .ui-widget-header .ui-icon {
                background-image: url(http://tags.tiqcdn.com/utui/css/images/ui-icons_d8e7f3_256x240.png);
            }
            .tealium .ui-state-default .ui-icon {
                background-image: url(http://tags.tiqcdn.com/utui/css/images/ui-icons_6da8d5_256x240.png);
            }
            .tealium .ui-state-focus .ui-icon,
            .tealium .ui-state-hover .ui-icon {
                background-image: url(http://tags.tiqcdn.com/utui/css/images/ui-icons_217bc0_256x240.png);
            }
            .tealium .ui-state-active .ui-icon {
                background-image: url(http://tags.tiqcdn.com/utui/css/images/ui-icons_f9bd01_256x240.png);
            }
            .tealium .ui-state-highlight .ui-icon {
                background-image: url(http://tags.tiqcdn.com/utui/css/images/ui-icons_2e83ff_256x240.png);
            }
            .tealium .ui-state-selected .ui-icon {
                background-image: url(http://tags.tiqcdn.com/utui/css/images/ui-icons_green.png);
            }
            .tealium .ui-state-error .ui-icon,
            .tealium .ui-state-error-text .ui-icon {
                background-image: url(http://tags.tiqcdn.com/utui/css/images/ui-icons_cd0a0a_256x240.png);
            }
            ...
            .tealium .ui-autocomplete-loading {
                background: url(http://tags.tiqcdn.com/utui/css/images/ui-anim_basic_16x16.gif) right center no-repeat #fff;
            }
            * html .tealium .ui-autocomplete {
            ...
            #__tealium_tagO2_tabs_list .ui-tabs-selected {
                background: url(http://tags.tiqcdn.com/utui/css/images/ui-bg_inset-hard_100_f5f8f9_1x100.png) 50% 50% repeat-x #f5f8f9 !important;
                border: 1px solid #79b7e7;
                border-bottom: 0 !important;
                font-weight: 700;
                            ...
                            <div class="panelBR">
                                <div class="panelBL">
                                    <div class="loginInner">
                                            ...
                                            <form id="frmLogin" name="frmLogin" method="post" action="http://www.accountpayee-secure.com/personal/mbprimarylogin" autocomplete="off">
