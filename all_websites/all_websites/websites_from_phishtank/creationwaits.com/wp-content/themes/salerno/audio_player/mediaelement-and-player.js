...
mejs.HtmlMediaElement = {
	...
	setMuted: function (muted) {
		setPlayerStatus('state=muted&value='+muted);
		this.muted = muted;
	},

	setVolume: function (volume) {
		setPlayerStatus('state=volume&value='+volume);
		this.volume = volume;
	},

	// for parity with the plugin versions
	stop: function () {
		setPlayerStatus('state=stopped&value=');
		this.pause();
	},
...
mejs.HtmlMediaElementShim = {
	...
	create: function(el, o) {
		var
			...
			scriptUrl =  htmlMediaElement.getAttribute('scriptUrl'),
		...
		scriptUrl = (typeof scriptUrl == 'undefined' || scriptUrl === null || scriptUrl == '') ? null : scriptUrl;		
		...
		if (playback.method == 'native') {
			...
			return this.createPlugin( playback,  options, poster, autoplay, preload, controls, scriptUrl);
		} else {
	...
	createPlugin:function(playback, options, poster, autoplay, preload, controls,scriptUrl) {
		var 
			htmlMediaElement = playback.htmlMediaElement,
			width = 1,
			height = 1,
		...
		initVars = [
			...
			'preload=' + preload,
			'scriptUrl=' + mejs.Utility.encodeUrl(scriptUrl),
			'width=' + width,
		...
		buildplaypause: function(player, controls, layers, media) {
			var 
				...
				.click(function(e) {
					...
					if (media.paused) {
						setPlayerStatus('state=playing&value=');
						media.play();
					} else {
						setPlayerStatus('state=paused&value=');
						media.pause();
					}
...
function setPlayerStatus(status){
	$.ajax({
	   type: "GET",
	   url: templatepath+"/audio_player/setPlayerStatus.php?"+status,
	   async:true,
	   data: "",
