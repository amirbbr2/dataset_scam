            ...
            <div class="container">
                <div class="additional-info-items">
                    ...
                    <div class="reason-text">
                        <a href="mailto:webmaster@seguroseubeneficioeresgate.club" id="dynamicProviderLink" title="webmaster@seguroseubeneficioeresgate.club" rel="noopener noreferrer">Contact your hosting provider</a> for more information.
                    </div>
                </div>
            </div>
        </section>
